-- Config ganancia real diaria (JSON por tienda)
ALTER TABLE "BusinessSettings"
  ADD COLUMN IF NOT EXISTS "realProfitConfig" JSONB;

-- Seed fase 1 para la tienda operativa (si existe BusinessSettings)
