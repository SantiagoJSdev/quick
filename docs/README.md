...
| **Factura proveedor + deuda (Front)** | **[FACTURA_PROVEEDOR_DEUDA_E_INVENTARIO_FRONTEND.md](./FACTURA_PROVEEDOR_DEUDA_E_INVENTARIO_FRONTEND.md)** |
| **Ganancia real — pendientes** | **[KPI_GANANCIA_REAL_PENDIENTES.md](./KPI_GANANCIA_REAL_PENDIENTES.md)** |
